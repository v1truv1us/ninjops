...
"examples/business-site.md": {
	id: "examples/business-site.md";
  slug: "examples/business-site";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"examples/web-application.md": {
	id: "examples/web-application.md";
...
"guides/ai-assistance.md": {
	id: "guides/ai-assistance.md";
  slug: "guides/ai-assistance";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"guides/creating-quotes.md": {
	id: "guides/creating-quotes.md";
...
"guides/http-api.md": {
	id: "guides/http-api.md";
  slug: "guides/http-api";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"guides/invoice-ninja-sync.md": {
	id: "guides/invoice-ninja-sync.md";
